...
class dataset_val(Dataset):
    def __init__(self, text_tokenizer, max_seq=2048, max_img_size=10, image_num=32, voc_size=153376, down_sample_ratio=1):
        ...
        ctrg_dataset = CTRG_Dataset(
            data_dir='/media/t1/zcy/dataset/',
            data_json='/media/t1/sym/dia-pangu/src/Dataset_EN/my_dataset/annotation_en.json',
            label_path='/media/t1/sym/dia-pangu/src/Dataset_EN/my_dataset/CTRG_finding_labels.csv',
            split='val',
        )
